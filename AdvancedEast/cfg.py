...
data_dir = 'icpr/'
tmp_img_dir_name = '/Users/lige/src/dfjx_ocr/tmp/'
gen_origin_img = True
draw_gt_quad = True
draw_act_quad = True
...
saved_model_weights_file_path = 'AdvancedEast/checkpoints/east_model_weights_%s.h5'\
                                % train_task_id
...
generation_prediction_img_during_predict = True
